...
class TabPreprocessor(BasePreprocessor):
    ...
    scale: bool, default = True
        ...
        :obj:`src.models.transformers._embedding_layers`
    ...
    for_transformer: bool, default = False
        ...
        (See :obj:`src.models.transformers`). If ``True``, the
    ...
    shared_embed: bool, default = False
        ...
        :obj:`src.models.transformers._layers.SharedEmbeddings`.
    ...
    label_encoder: LabelEncoder
        see :class:`src.utils.dense_utils.LabelEncder`
